...
urlpatterns = [
    ...
    url(r'^request_detail/(?P<consumerRequest_pk>[0-9]+)/update$', views.updateListing, name='web_request_update'),
    url(r'^consumer_detail/(?P<consumer_pk>[0-9]+)/update$', views.updateConsumer, name='web_consumer_update'),
    url(r'^producer_detail/(?P<producer_pk>[0-9]+)/update$', views.updateProducer, name='web_producer_update'),
    ...
    url(r'^search_consumer_results$',views.searchConsumerResults, name='web_search_consumer_results'),
    url(r'^search_producer_results$',views.searchProducerResults, name='web_search_producer_results'),
